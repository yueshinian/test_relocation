...
FitAllanAcc::FitAllanAcc( std::vector< double > sigma2s, std::vector< double > taus, double freq )
: C_Q_(0.0 )
, C_N_(0.0 )
, C_B_(0.0 )
, C_K_(0.0 )
...
double
FitAllanAcc::calcSigma2(double C_Q, double C_N, double C_B, double C_K, double C_R, double tau ) const
{
    // clang-format off
